        ...
        <div class="col-md-12">
            ...
            <div class="panel-body">                
             <form class="form-inline" action="{{ route('aposta.salvar')}}" method="post">
                 ...
                 <div class="form-group {{ $errors->has('nome_jogador') ? 'has-error' : ''}}">
                    <label for="nome_apostador">Nome</label>
                    <input type="text" class="form-control" name="nome_apostador" placeholder="Digite seu nome">
                ...
                <div class="form-group {{ $errors->has('valor_casa') ? 'has-error' : ''}}">
                    <label class="sr-only" for="valor_aposta">Valor</label>
                    <div class="input-group">
                        <div class="input-group-addon">$</div>
                        <input type="number" class="form-control" name="valor_aposta" placeholder="Valor">                     
