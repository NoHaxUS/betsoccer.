...
class JogoRequest extends Request
{
    ...
    public function rules()
    {
    	...
    	'valor_casa'=>'different:valor_empate|different:valor_fora|different:valor_1_2|different:valor_dupla|different:max_gol_2|different:min_gol_3|different:ambas_gol|required|numeric',
    	'valor_empate'=>'different:valor_casa|different:valor_fora|different:valor_1_2|different:valor_dupla|different:max_gol_2|different:min_gol_3|different:ambas_gol|required|numeric',
    	'valor_fora'=>'different:valor_casa|different:valor_empate|different:valor_1_2|different:valor_dupla|different:max_gol_2|different:min_gol_3|different:ambas_gol|required|numeric',
    	'valor_1_2'=>'different:valor_casa|different:valor_fora|different:valor_empate|different:valor_dupla|different:max_gol_2|different:min_gol_3|different:ambas_gol|required|numeric',
    	'valor_dupla'=>'different:valor_casa|different:valor_fora|different:valor_empate|different:valor_1_2,max_gol_2|different:min_gol_3|different:ambas_gol|required|numeric',
    	'max_gol_2'=>'different:valor_casa|different:valor_fora|different:valor_empate|different:valor_1_2|different:valor_dupla|different:min_gol_3|different:ambas_gol|required|numeric',
    	'min_gol_3'=>'different:valor_casa|different:valor_fora|different:valor_empate|different:valor_1_2|different:valor_dupla|different:max_gol_2|different:ambas_gol|required|numeric',
    	'ambas_gol'=>'different:valor_casa|different:valor_empate|different:valor_fora|different:valor_1_2|different:valor_dupla|different:max_gol_2|different:min_gol_3|required|numeric',
