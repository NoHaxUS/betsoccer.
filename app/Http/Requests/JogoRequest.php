...
class JogoRequest extends Request
{
    ...
    public function rules()
    {
    	...
    	'valor_casa'=>'different:valor_empate,valor_fora,valor_1_2,valor_dupla,max_gol_2,min_gol_3,ambas_gol|required|numeric',
    	'valor_empate'=>'different:valor_casa,valor_fora,valor_1_2,valor_dupla,max_gol_2,min_gol_3,ambas_gol|required|numeric',
    	'valor_fora'=>'different:valor_casa,valor_empate,valor_1_2,valor_dupla,max_gol_2,min_gol_3,ambas_gol|required|numeric',
    	'valor_1_2'=>'different:valor_casa,valor_fora,valor_empate,valor_dupla,max_gol_2,min_gol_3,ambas_gol|required|numeric',
    	'valor_dupla'=>'different:valor_casa,valor_fora,valor_empate,valor_1_2,max_gol_2,min_gol_3,ambas_gol|required|numeric',
    	'max_gol_2'=>'different:valor_casa,valor_fora,valor_empate,valor_1_2,valor_dupla,min_gol_3,ambas_gol|required|numeric',
    	'min_gol_3'=>'different:valor_casa,valor_fora,valor_empate,valor_1_2,valor_dupla,max_gol_2,ambas_gol|required|numeric',
    	'ambas_gol'=>'different:valor_casa,valor_empate,valor_fora,valor_1_2,valor_dupla,max_gol_2,min_gol_3|required|numeric',
