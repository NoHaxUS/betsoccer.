...
class JogoRequest extends Request
{
    ...
    public function rules()
    {
    	...
    	'valor_empate'=>'different:valor_fora,valor_1_2,valor_dupla,max_gol_2,min_gol_3,ambas_gol|required|max:15|numeric',
    	'valor_fora'=>'different:valor_1_2,valor_dupla,max_gol_2,min_gol_3,ambas_gol|required|max:15|numeric',
    	'valor_1_2'=>'different:valor_dupla,max_gol_2,min_gol_3,ambas_gol|required|max:15|numeric',
    	'valor_dupla'=>'different:max_gol_2,min_gol_3,ambas_gol|required|max:15|numeric',
    	'max_gol_2'=>'different:min_gol_3,ambas_gol|required|max:15|numeric',
    	'min_gol_3'=>'different:ambas_gol|required|max:15|numeric',
